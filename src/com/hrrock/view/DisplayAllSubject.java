	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			if(rs.next())
			{
				...
				out.println("<tr><th>Sn</th><th>Branch<br>Id<br>Branch<br>Name</th><th>Subject<br>Id</th><th>Subject><br>Name></th><th>Semester</th><th>Update</th></tr>");
				int sn=1;
				do{
					out.println("<tr><td>"+sn+"</td><td>"+rs.getString(2)+"</td><td>"+rs.getString(4)+"</td><td>"+rs.getString(5)+"</td><td>"+rs.getString(6)+"</td><td><a href=DisplaySubjectById?subject_id="+rs.getString(3)+">Edit/Delete</a></td></tr>");
				sn++;
				}while(rs.next());
